...
export default class SouthDistribution extends React.Component {
    
    componentDidMount() {
        let distribution_southFiberLayer = this.props.item.southDistribution
       ...
       /* view.watch(["stationary"], function () {     
            ...
            if (scale < 9050) {
                ...
                distribution_southFiberLayer.definitionExpression = "1=1"

            } if (scale > 9050) {
            
                distribution_southFiberLayer.definitionExpression = "network='Feeder'"
            }

        }); */
        distribution_southFiberLayer.definitionExpression = "network='Distribution'"
        distribution_southFiberLayer.renderer = rendererCheck
