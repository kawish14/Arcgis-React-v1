...
export default class NorthFeeder extends React.Component {
    
    componentDidMount() {
        let feeder_southFiberLayer = this.props.item.southFeeder
       ...
       view.watch(["stationary"], function () {     
            ...
            if (scale < 9050) {
                ...
                feeder_southFiberLayer.definitionExpression = "1=1"

            } if (scale > 9050) {
            
                feeder_southFiberLayer.definitionExpression = "network='Feeder'"
            }

        }); 

        feeder_southFiberLayer.renderer = rendererCheck
