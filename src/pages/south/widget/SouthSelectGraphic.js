...
componentDidMount(){
    ...
    const south = this.props.item.customer
...
componentWillUnmount(){
    ...
    this.props.map.removeMany([this.state.polygonGraphicsLayer,this.state.polylineGraphicsLayer]);
        ...
        <div>
            ...
            {this.state.selectionTable ?
                ...
                {/************************ Selection Tab of Table **********************/}
                    ...
                    {this.state.southCPEnav ?
                        <li className="southCPE-tab" onClick={this.southCPEtoggle}><a data-toggle="tab" href="#southCPE">Selected Customer - {this.state.southCPEAttributes.length}</a></li>
                        :
                        null
                    }
                {/************************* Download Link **********************/}
            ...
            {/**************************** South customer Table ********************************/}
                ...
                <div className="tab-content">
                    ...
                    <div id="southCPE" className="tab-pane fade in active">
