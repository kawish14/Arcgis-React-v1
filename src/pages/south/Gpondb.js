...
function Gpondb (props){
        ...
        return (
            ...
            { props.summaryTableFun ? null : 
                <table id="example" className="table table-bordered table-striped js-basic-example dataTable" style ={styels.table}>
                    ...
                    <tr>
                        ...
                        <td className="col-md-2">{props.southStatus.LOS}</td>
